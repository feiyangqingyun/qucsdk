#ifndef YSCROLLBARV_H
#define YSCROLLBARV_H
...
#ifdef quc
class Q_DECL_EXPORT YScrollBarV : public QWidget
#else
class YScrollBarV : public QWidget
#endif
...
public:
    explicit YScrollBarV(QWidget *parent = 0);
